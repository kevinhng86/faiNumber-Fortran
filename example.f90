program example
    ! For 64/128, use fniDecimalUtil64/fniDecimalUtil128.
    ...
    ! For 64/128, use decToInt64/decToInt128.
    errorLogical = decToInt32("123", resultValue)
    ...
    startpos = 13
    endpos = 17
    errorLogical = decToInt32(" This here($12345)can be parse with start and end", &
                     resultValue, startpos, endpos)
    ...
    !
    ! For 64/128, use decToInt64TrueError/decToInt128TrueError
    startpos = 12
    errorInt = decToInt32TrueError("  line 24: 1278421", resultValue, startpos) ! startpos can be used without endpos,
